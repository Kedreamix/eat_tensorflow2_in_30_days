## 1-2 图片数据建模流程范例 (cifar2图片分类问题)
<!-- TOC -->

- [1-2,图片数据建模流程范例](#1-2图片数据建模流程范例)
    - [一，准备数据](#一准备数据)
    - [二，定义模型](#二定义模型)
    - [三，训练模型](#三训练模型)
    - [四，评估模型](#四评估模型)
...
![img](https://ask.qcloudimg.com/http-save/yehe-7694870/gx6mmo4q9p.png?imageView2/2/w/1620#pic_center)
...
![image-20220817194220834](data/jpg/1-2-tensorboard.jpg)
...
![](data/jpg/1-2-Loss曲线.jpg)

```python
plot_metric(history,"accuracy")
```

![](data/jpg/1-2-Accuracy曲线.jpg)
