...
- [2-2,三种计算图](#2-2三种计算图)
    ...
    - [二，静态计算图](#二静态计算图)
    - [三，动态计算图](#三动态计算图)
    - [四，TensorFlow2.0的Autograph](#四tensorflow20的autograph)
...
![](./data/jpg/2-2-tensorboard计算图.jpg)

当然现在，有更新了，显示的图的路径会更大，并且分开显示，也可以在在线的colab体验一下代码

![image-20220820135921018](./data/jpg/2-2-tensorboard计算图2.jpg)
